		  ...
		  <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    ?>                  
                        <?php
                            $result =mysqli_query($con,"SELECT name,phone,email,user.uname,adhar,utype,pic FROM `user`,`login` WHERE user.uname=login.uname and user.status=1 and utype='S' order by name;");
                        ?>
