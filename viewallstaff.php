		  ...
		  <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    ?>                  
                        <?php
                            $result =mysqli_query($con,"SELECT name,phone,email,user.uname,adhar,utype,pic FROM `user`,`login` WHERE user.uname=login.uname and user.status=1 and utype='T' order by name;");
                        ?>
                    ...
                    <div class="table-users">
                        ...
                        <tr>
                           ...
                           <tr>
                              ...
                              <td><b><a href="userprofile.php?uname=<?php echo $t['uname']; ?>"><?php echo $t['name']; ?> </a></b> </td>
