					...
					<div class="col-lg-9 col-sm-9 col-sm-9 padbot20">
						...
						<div class="sorting_options clearfix">
							<?php
                                                            ...
                                                            $result4=mysqli_query($con,"SELECT COUNT(*)as count FROM items WHERE subcategory_id='$id' and status=1;");
							...
							<div class="tovar_wrapper col-lg-4 col-md-4 col-sm-6 col-xs-6 col-ss-12 padbot40">
                                                        ...
                                                        <?php 
                                                            if(isset($_POST['submit']))
                                                            {
                                                                $sbc=$_POST['sort_sel'];
                                                                if($sbc=='p'){
                                                                    $qry3="select * from `items` WHERE subcategory_id='$id' and status=1 order by date";
                                                                }
                                                                elseif($sbc=='d'){
                                                                    $qry3="select * from `items` WHERE subcategory_id='$id' and status=1 order by date desc";
                                                                }
                                                            ...
                                                            $query3="select * from `items` WHERE subcategory_id='$id' and status=1";
                                                            ...
                                                            ?>
                                                                    <td>
                                                                            ...
                                                                            ?>
                                                                            <a href="itemdetails.php?enc=<?php echo $enc;  ?>" ><button type="submit" value="More Details1" name="submit" class="button1"/>More Details</button>
                                                                               </a>
                                                                            </center> 
                                                                        </div>
                                                                     <!--  </form> -->
