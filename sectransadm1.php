		  ...
		  <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    ?>                  
                        <?php
                            $result =mysqli_query($con,"SELECT sh_item.`sitem_id`, sh_item.`uname`, sh_item.`sitem_name`, sh_item.`sprice`, sh_item.`sdes`, sh_item.`simg`, DATE(sh_item.`date`) as date, sh_item.`status`,user.`uname`,user.`name` FROM `sh_item`,`user` where sh_item.uname=user.uname and sh_item.status=4;");
                        ?>
                    ...
                    <div class="table-users">
                        ...
                        <center>
                            <b><a href="sectransadm.php">Unsold Items </a></b> 
                        </center>
