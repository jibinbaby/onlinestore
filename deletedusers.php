		  ...
		  <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    ?>                  
                        <?php
                            $result =mysqli_query($con,"SELECT * FROM `user` WHERE status=0 order by name;");
                        ?>
                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
                    
                    <div class="table-users">
                        <div class="header">Deleted Users</div>
                        ...
                        <table cellspacing="0" id="myTable">
                           ...
                           <tr>
                              ...
                              <td><a onclick="return confirm('Do you want to add this user..!');" href="useradd1.php?uname=<?php echo $t['uname']; ?> " style="color:green;">ADD</a></td> 
                           </tr>
                         <?php
                                }
                        }
