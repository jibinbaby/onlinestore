...
$ret ="SELECT `COLUMN_NAME` FROM `INFORMATION_SCHEMA`.`COLUMNS` WHERE `TABLE_SCHEMA`='global_db' AND `TABLE_NAME`='user' or `TABLE_NAME`='purchase' or `TABLE_NAME`='payment' or `TABLE_NAME`='items'";
