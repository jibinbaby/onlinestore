		...
		<div id="page-wrapper">
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    ?>
                    <?php
                        if($records1['status']==1){
                    ?>
                    <div class="container">
                        <img src="profile/admin.jpg" alt="Avatar" style="width:100%;">Admin Team
                        <p><?php echo ucfirst("{$records1['msg']}"); ?></p>
                        <span class="time-right"><?php echo "{$records1['date']}"; ?></span>
                    </div>
                    <?php
                        }elseif($records1['status']==2 || $records1['status']==4){
    ...
    <script type="text/javascript" src="assets/js/chartjs.js"></script> 
     ...
     <?php
            if(isset($_POST["gl_item_addbtn"])){
                ...
                $sql4="INSERT INTO `chat`(`uname`, `msg`,`status`) VALUES($uname,'$replay',1)";
                echo $sql4;
                if (mysqli_query($con,$sql4) > 0){
                    echo "<script>window.location.href='chatting.php?uname=$uname'</script>";
                }
                else{
