                    ...
                    <div class="table-users">
                        ...
                        <table cellspacing="0" id="myTable">
                           ...
                           <tr>
                              ...
                              <td><b><?php echo ucfirst($t['c_name']);?></b> </td>
                              <td><a onclick="return confirm('Do you want to delete this Category..!');" href="categorydelete.php?uname=<?php echo $t['category_id']; ?> " style="color:red;">Delete</a></td>
                           </tr>
                         <?php
                                }
                        }
