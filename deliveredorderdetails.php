		  ...
		  <div class="header"> 
						...
						<ol class="breadcrumb">
                                                    <li><a href="userhome.php">Home</a></li>
                                                     <li class="active">Deliverd Order Details</li>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    ?>                  
                        <?php
                             $result =mysqli_query($con,"SELECT * FROM `purchase` WHERE status=4 order by date;");
                        ?>
                    <div class="table-users">
                        <div class="header">Deliverd Order Details</div>
