    ...
    background: #109177;
        ...
        <script>
            function  addSubCategory(){
                var gl_sub_category_name= document.gl_sub_cate_form.gl_sub_category_name.value;
                if((gl_sub_category_name===null)||(gl_sub_category_name.length<3)){
                    document.gl_sub_cate_form.gl_sub_category_name.style.border = "1px solid red";
                    alert("Enter Valid Sub Category Name");
                    document.gl_sub_cate_form.gl_sub_category_name.focus();
                    return false;
                }
//                var fnam=/^[a-zA-Z ]{4,25}$/;
//                if(document.gl_sub_cate_form.gl_sub_category_name.value.search(fnam)==-1)
//                {
...
//                
//                }
                if((gl_sub_category_name.length>25)){
                    document.gl_sub_cate_form.gl_sub_category_name.style.border = "1px solid red";
                ...
                <div class="row">
                    <center>
                            ...
                            <div class="form-style-5" style="border:2px solid cyan;">
                                <form class="gl_sub_cate_form" name="gl_sub_cate_form" action="#" method="POST"  onsubmit="return addSubCategory()" enctype="multipart/form-data">
                                    <fieldset>
                                        <legend><span class="number">.</span> Add Sub Category</legend>
                                         <select name="gl_sub_category_category" id="gl_sub_category_category" required>
                                            <?php
                                        ...
                                        <input type="text" placeholder="Sub Category Name" name="gl_sub_category_name"  id="gl_sub_category_name" required>
                                        <br/>

                                        <input type="file" placeholder="Category Image" name="gl_sub_category_pic"  id="gl_sub_category_pic" required>
                                        <br/>     
                                    </fieldset>
                                    <div class="gl_category_clearfix">
                                        <input type="submit" class="gl_sub_categoty_addbtn" id="gl_sub_categoty_addbtn" name="gl_sub_categoty_addbtn" value="Go" >
                                    </div>
                                </form>
                            </div>
                    </center>
                    ...
                    <div class="table-users">
                        ...
                        <table cellspacing="0" id="myTable">
                           ...
                           <tr>
                              ...
                              <td><?php  echo ucfirst($t['sub_cname']);  ?></td>
